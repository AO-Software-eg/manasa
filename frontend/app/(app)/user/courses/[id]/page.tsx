    ...
    <div className="space-y-8 mt-12">
      <div className="bg-[#1C1C18] border-2 border-[#e6d3a3]/50 p-8 rounded-2xl flex flex-col items-center justify-center">
        <div className="relative  pt-4 text-center">
          <h2 className="text-3xl font-bold mb-6 text-[#e6d3a3]">المحتوى مقفل</h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl">قم بشراء الكورس للوصول إلى جميع الدروس والمواد</p>
