    ...
    <div className="flex flex-col gap-4 w-full my-10 p-4" dir="rtl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <CardLayout classname="flex flex-col items-center gap-5 py-8">
          ...
          >
            ...
            <span className="absolute inset-0 bg-background/80 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-1">
              ...
              <span className="text-primary text-[10px] font-medium">تغيير</span>
            </span>
          </button>

          <div className="text-center">
            <h2 className="text-xl font-bold text-foreground flex items-center gap-3 group">{userData?.name || "—"} <span><Edit width={20} className="opacity-40 transition-all duration-300 group-hover:opacity-100" /></span></h2>
        ...
        <CardLayout classname="lg:col-span-2 flex flex-col gap-3">
          <h3 className="text-lg font-semibold text-foreground mb-1">بيانات الحساب</h3>
        ...
        >
          <div className="bg-card border border-border rounded-2xl shadow-2xl p-6 w-full max-w-sm mx-4 relative">
            ...
            <div className="flex flex-col items-center gap-1 mb-5">
              ...
              <h2 className="text-base font-bold text-foreground">تغيير الصورة الشخصية</h2>
              <p className="text-xs text-muted-foreground">اختر صورة من جهازك لتحديث ملفك الشخصي</p>
            </div>
