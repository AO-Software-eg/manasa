...
import { lectures, lectureVideos, exams, questions, questionChoices, courseEnrollments, examSubmissions, users, courses, lectureVideoCompletions, wallets, answerSubmissions } from "./schema.ts";
...
export const lectureVideoCompletionsRelations = relations(lectureVideoCompletions, ({one}) => ({
	courseEnrollment: one(courseEnrollments, {
